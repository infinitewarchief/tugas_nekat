...
{{-- navbar --}}
					...
					<div class="row">
						<div class="col-sm-6 mb-4 mb-xl-0">
							<div class="d-lg-flex align-items-center">
								<div>
									<h3 class="text-dark font-weight-bold mb-2">Hi, Selamat datang kembali!</h3>
								</div>
						...
						<div class="col-lg-8 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<div class="col-lg-5">
											<h4 class="card-title">Jenis Pendaftaran</h4>
											<div class="row">
												<div class="col-sm-4">
													<ul class="graphl-legend-rectangle">
														<li><span class="bg-danger"></span>Jalur Undangan</li>
														<li><span class="bg-warning"></span>Jalur Prestasi</li>
														<li><span class="bg-info"></span>Jalur Reguler</li>
													</ul>
												</div>
										...
										<div class="col-lg-3">
											<h4 class="card-title">Jumlah diterima</h4>
											<div class="row">
												<div class="col-sm-12">
												...
												<div class="col-sm-12">
													<ul class="graphl-legend-rectangle">
														<li><span class="bg-danger"></span>Jalur Undangan (15%)</li>
														<li><span class="bg-warning"></span>Jalur Prestasi (20%)</li>
														<li><span class="bg-success"></span>Jalur Reguler (40%)</li>
													</ul>
												</div>
											</div>
										</div>
    ...
    <script src="{{ asset('vendor/dashboard/progressbar.js/progressbar.min.js') }}"></script>
	<script src="{{ asset('vendor/dashboard/chartjs-plugin-datalabels/chartjs-plugin-datalabels.js') }}"></script>
	<script src="{{ asset('vendor/dashboard/justgage/raphael-2.1.4.min.js') }}"></script>
	<script src="{{ asset('vendor/dashboard/justgage/justgage.js') }}"></script>
    <script src="{{ asset('vendor/dashboard/js/jquery.cookie.js') }}" type="text/javascript"></script>
    <!-- End plugin js for this page -->
