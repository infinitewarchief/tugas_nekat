...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('vendor/dashboard/select2-bootstrap-theme/select2-bootstrap.min.css') }}">
...
<body>
  ...
  <!-- endinject -->
  <!-- plugin js for this page -->
  <script src="{{ asset('vendor/dashboard/typeahead.js/typeahead.bundle.min.js') }}"></script>
  <script src="{{ asset('vendor/dashboard/select2/select2.min.js') }}"></script>
  <!-- End plugin js for this page -->
  <!-- Custom js for this page-->
  <script src="{{ asset('vendor/dashboard/js/file-upload.js') }}"></script>
  <script src="{{ asset('vendor/dashboard/js/typeahead.js') }}"></script>
  <script src="{{ asset('vendor/dashboard/js/select2.js') }}"></script>
